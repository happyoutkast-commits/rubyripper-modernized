...
```text
dist/rubyripper-bundled_0.9.2-1_amd64.deb
```
...
```bash
dpkg-deb --info dist/rubyripper-bundled_0.9.2-1_amd64.deb
dpkg-deb --contents dist/rubyripper-bundled_0.9.2-1_amd64.deb
sudo apt install ./dist/rubyripper-bundled_0.9.2-1_amd64.deb
```
